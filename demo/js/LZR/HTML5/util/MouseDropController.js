...
LZR.HTML5.Util.MouseDropController.prototype.version = "0.0.5";
...
LZR.HTML5.Util.MouseDropController.prototype.disable = function() {
	if (this.callbacks.mCurrentMove) {
		...
		this.callbacks.mCurrentMove = null;
	}
...
LZR.HTML5.Util.MouseDropController.prototype.mouseWheel = function(e) {
	...
	// 记录鼠标位置
	if (this.noCurrentMove) {
		this.currentPage = LZR.HTML5.Util.getMousePosition(e);
	}
...
// 鼠标按下响应事件（接口）
LZR.HTML5.Util.MouseDropController.prototype.autoMouseDown = function() {};

// 鼠标抬起响应事件（接口）
LZR.HTML5.Util.MouseDropController.prototype.autoMouseUp = function() {};
