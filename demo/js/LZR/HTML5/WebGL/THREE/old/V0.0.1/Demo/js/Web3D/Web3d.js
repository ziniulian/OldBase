/*
		...
		<script src="js\\LZRutil\LZRutil.js"></script>
		<script src="js\\LZRutil\MouseDropController.js"></script>
		<script src="js\Web3D\OrthographicControl.js"></script>
		<script src="js\Web3D\CoordinateChange.js"></script>
*/
...
Web3d.prototype.init = function(obj) {
	...
	// 生成控制器
	this.controls = new THREE.OrthographicControl({
		ctrlDom: this.canvas,
		camera: this.camera,
		light: this.light,
		center: this.center
...
// 加载3D档案
Web3d.prototype.load3D = function(url) {
	switch (Lzrut.getFileExtension(url)) {
		case "obj":
			this.loadObj(url);
			break;
		default:
...
// 加载JSON档案
Web3d.prototype.loadJson = function(url) {
...
Web3d.prototype.control = function() {
	requestAnimationFrame(this.control.bind(this));
...
// 添加场景坐标系
Web3d.prototype.addSceneCoo = function() {
...
// 删除场景坐标系
Web3d.prototype.delSceneCoo = function() {
	if (!this.testLine["sceneX"]) return;
	this.scene.remove(this.testLine.sceneX);
	this.scene.remove(this.testLine.sceneY);
	this.scene.remove(this.testLine.sceneZ);
	delete(this.testLine.sceneX);
	delete(this.testLine.sceneY);
	delete(this.testLine.sceneZ);
};

// 添加旋转中心坐标系
Web3d.prototype.addCenterCoo = function() {
...
// 删除旋转中心坐标系
Web3d.prototype.delCenterCoo = function() {
	if (!this.testLine["centerX"]) return;
	this.scene.remove(this.testLine.centerX);
	this.scene.remove(this.testLine.centerY);
	this.scene.remove(this.testLine.centerZ);
	delete(this.testLine.centerX);
	delete(this.testLine.centerY);
	delete(this.testLine.centerZ);
};

// 添加相机坐标系
Web3d.prototype.addCameraCoo = function() {
...
// 删除相机坐标系
Web3d.prototype.delCameraCoo = function() {
	if (!this.testLine["camerarX"]) return;
	this.scene.remove(this.testLine.camerarX);
	this.scene.remove(this.testLine.camerarY);
	this.scene.remove(this.testLine.camerarZ);
	delete(this.testLine.camerarX);
	delete(this.testLine.camerarY);
	delete(this.testLine.camerarZ);
};
...
// 画线
Web3d.prototype.line = function (p1, p2, colorValue) {
