...
function CoordinateChange (obj) {
	if (obj) {
		this._CoordinateChange (obj);
	}
}
CoordinateChange.prototype.className = "CoordinateChange";
CoordinateChange.prototype._CoordinateChange = function (obj) {
/*
	参数说明：
	{
		s: {		// 原坐标系
...
// 三点法计算 R
CoordinateChange.prototype.computeR3 = function () {
	/* BUG：
		目前公式错误，不知原因，无法使用。
	*/
...
// 四点法计算 R
CoordinateChange.prototype.computeR4 = function () {
	/* BUG：
...
// 坐标转换
CoordinateChange.prototype.trans = function(ps, obj) {
	var	pt,
		x = ps.x,
		y = ps.y,
		z = ps.z;
