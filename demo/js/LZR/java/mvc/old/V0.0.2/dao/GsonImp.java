...
import lzr.java.mvc.bean.TestBean;
...
public class GsonImp implements InfJson {
	...
	public List<Map<String, Object>> toMaps(String json) {
		return gs.fromJson(json, new TypeToken<List<Map<String, Object>>>(){}.getType());
	}

	@Override
	public Map<String, Object> toMap(String json) {
		return gs.fromJson(json, new TypeToken<Map<String, Object>>(){}.getType());
	}
